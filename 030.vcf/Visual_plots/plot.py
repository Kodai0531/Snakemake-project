...
#   plot-vcfstats -P -p 030.vcf/Visual_plots/ 030.vcf/snp_raw.stats
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. snp_r .. 030.vcf/snp_raw.vcf
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='snp_r')
    has_data = 1
